        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Form Kategori Pekerjaan</div>
                </div>
                <div class="card-body">
                    <form action="{{ route('manajemen_pekerjaan.kategori.simpan') }}" method="POST">
                    @csrf
                        <div class="row">
                            <div class="col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label for="kategori_pekerjaan">Kategori Pekerjaan</label>
                                    <input type="text" name="kategori_pekerjaan" id="kategori_pekerjaan" class="form-control form-control-sm @error('kategori_pekerjaan') is-invalid @enderror" value="{{ old('kategori_pekerjaan') }}">
