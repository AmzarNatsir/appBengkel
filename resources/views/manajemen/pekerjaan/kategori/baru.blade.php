                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kategori_pekerjaan" id="kategori_pekerjaan" class="form-control @error('kategori_pekerjaan') is-invalid @enderror" value="{{ old('kategori_pekerjaan') }}">
