...
<div class="page-inner">
    ...
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        ...
        <div class="ms-md-auto py-2 py-md-0">
            <a href="{{ route('manajemen_pekerjaan.pekerjaan.baru') }}" class="btn btn-primary btn-round">Baru</a>
        </div>
    </div>
...
<script>
    $(document).ready(function () {
        ...
        $(".list_data").DataTable({
            ajax: "{{ route('manajemen_pekerjaan.pekerjaan.data') }}",
            processing: true,
            serverSide: true,
            autoWidth: true,
            columns: [
    ...
    var konfirmHapus = function(el)
        {
            ...
            {
                $.ajax({
                    url: "{{ url('manajemen_pekerjaan/pekerjaan_destroy') }}/"+$(el).val(),
                    type: "GET",
