...
<div class="page-inner">
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
            ...
            <h6 class="op-7 mb-2">Add Data Vehicle</h6>
        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Form Add Vehicle</div>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm  @error('plat_number') is-invalid @enderror" name="plat_number" id="plat_number">
                            ...
                            <div class="col-md-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-select @error('type_select') is-invalid @enderror" name="type_select" id="type_select">
                                        ...
                                        <option value="{{ $type->oid_type }}">{{ $type->getBrand->brand_name }} {{ $type->getModel->model_name }} {{ $type->type_name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-12 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-select @error('color_select') is-invalid @enderror" name="color_select" id="color_select">
                                        ...
                                        <option value="{{ $color->oid_color }}">{{ $color->color_idn }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-12 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-select @error('jenis_select') is-invalid @enderror" name="jenis_select" id="jenis_select">
                                        ...
                                        <option value="{{ $jenis->oid_jenis }}">{{ $jenis->jenis }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-select @error('customer_select') is-invalid @enderror" name="customer_select" id="customer_select">
                                        ...
                                        <option value="{{ $customer->oid_customer }}">{{ $customer->customer_name }}</option>
                                        @endforeach
                                    </select>
