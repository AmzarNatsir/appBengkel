        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Form Edit Common Model Brand</div>
                </div>
                <div class="card-body">
                    <form action="{{ url('common/modelUpdate', $data->id) }}" method="POST">
                    @csrf
                    {{ method_field('PUT') }}
                        <div class="row">
                            <div class="col-md-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="model_name" id="model_name" class="form-control form-control-sm @error('model_name') is-invalid @enderror" value="{{ $data->model_name }}">
                            ...
                            <div class="col-md-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-select @error('brand_select') is-invalid @enderror" name="brand_select" id="brand_select">
                                        ...
                                        <option value="{{ $brand->oid_brand }}" {{ ($brand->oid_brand == $data->oid_brand) ? "selected" : "" }}>{{ $brand->brand_name }}</option>
                                        @endforeach
                                    </select>
