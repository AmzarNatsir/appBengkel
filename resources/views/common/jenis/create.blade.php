        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Form Add Jenis</div>
                </div>
                <div class="card-body">
                    <form action="{{ url('common/jenisStore') }}" method="POST">
                    @csrf
                        <div class="row">
                            <div class="col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label for="jenis">Jenis</label>
                                    <input type="text" name="jenis" id="jenis" class="form-control form-control-sm @error('jenis') is-invalid @enderror" value="{{ old('jenis') }}">
                                    @if ($errors->has('jenis'))
