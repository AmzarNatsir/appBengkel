        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Form Add Brand</div>
                </div>
                <div class="card-body">
                    <form action="{{ url('common/brandStore') }}" method="POST">
                    @csrf
                        <div class="row">
                            <div class="col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label for="brand_name">Brand</label>
                                    <input type="text" name="brand_name" id="brand_name" class="form-control form-control-sm @error('brand_name') is-invalid @enderror">
