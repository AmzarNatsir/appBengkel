                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="color_idn" id="color_idn" class="form-control form-control-sm @error('color_idn') is-invalid @enderror" value="{{ $data->color_idn }}">
                            ...
                            <div class="col-md-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="color_eng" id="color_eng" class="form-control form-control-sm @error('color_eng') is-invalid @enderror" value="{{ $data->color_eng }}">
